package com.example.p51simpleadapterdata;
...
//http://startandroid.ru/ru/uroki/vse-uroki-spiskom/110-urok-51-simpleadapter-dobavlenie-i-udalenie-zapisej.html

//В этом уроке:
//- используем SimpleAdapter для построения списка
//- добавляем и удаляем записи в списке

//Сделаем список с возможностью удаления и добавления записей.
