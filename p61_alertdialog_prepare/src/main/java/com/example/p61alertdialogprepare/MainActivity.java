package com.example.p61alertdialogprepare;
...
public class MainActivity extends AppCompatActivity {
    ...
    //В onPrepareDialog мы на вход получаем ID вызываемого диалога и сам диалог (Dialog).
    //Мы преобразуем его к AlertDialog и пишем в текст диалога текущее время.
