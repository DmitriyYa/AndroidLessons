package com.example.p53simplecursortreeadapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    class MyAdapter extends SimpleCursorTreeAdapter {
        ...
        protected Cursor getChildrenCursor(Cursor groupCursor) {
            ...
            //В методе getChildrenCursor мы получаем id текущей группы
            // и по нему получаем курсор с данными об элементах группы.
